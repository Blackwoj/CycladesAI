...
class EventConfig:
    ...
    UPDATE_INCOME_POS = pygame.USEREVENT + 13
    SHOW_MULTIPLY_OPTIONS_WAR = pygame.USEREVENT + 14
    SHOW_MULTIPLY_OPTIONS_SHIP = pygame.USEREVENT + 15

    NEW_BUILDING = pygame.USEREVENT + 16
    NEW_WARRIOR = pygame.USEREVENT + 17
    NEW_SHIP = pygame.USEREVENT + 18

    ADD_CARD = pygame.USEREVENT + 19
    CHECK_BUILDING = pygame.USEREVENT + 20
    CHECK_ATHENS = pygame.USEREVENT + 21
